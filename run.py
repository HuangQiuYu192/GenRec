...
p.add_argument("--seed", type=int, default=42); p.add_argument("--debug", action="store_true"); a = p.parse_args(); set_seed(a.seed)
...
output = {"dataset":dataset.name,"protocol":"faithful","device":device,"valid_metrics":valid,"test_metrics":test,"index":index.diagnostics(),"resource":resource}
